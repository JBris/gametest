...
export class PaddleAttackSingle extends PaddleAttack{
    ...
    **Methods**
    ...
    protected launchProjectileAttack(): void {
        let numberOfShots : number = 1 + this.z_paddle.BaseNumberOfShots;
  
        this.z_paddle.game.time.events.repeat(Phaser.Timer.SECOND * 0.35, numberOfShots, this.fireSingleShot, this);
    }
