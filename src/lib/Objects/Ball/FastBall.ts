...
export class FastBall extends Ball{
...
{
        super(game, x, y, 1,relativeScalingXValue,relativeScalingY,baseVelocityX,baseVelocityY);
    }
    ...
    **Methods**
    ...
    initDefaultBehaviour() {
        if (this.z_baseVelocityX === null)
            this.z_baseVelocityX = -100;
        if (this.z_baseVelocityY === null)
            this.z_baseVelocityY = -500;
